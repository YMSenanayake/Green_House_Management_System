  ...
  useEffect(() => {
    async function getItem() {
      try {
        ...
        const response = (await axios.post(`http://localhost:3000/api/inventory/getitem/${itemid}`)).data;
...
async function Updateitem(e){
  ...
  try {
    ...
    const response = (await axios.put(`http://localhost:3000/api/inventory/updateitem/${itemid}`,updateitem)).data;
